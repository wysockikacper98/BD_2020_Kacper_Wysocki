...
//    $ID_REZERWACJI = $request->data->ID_REZERWACJI;
//    $ID_KLIENTA = $request->data->ID_KLIENTA;
//    $ID_SAMOCHODU = $request->data->ID_SAMOCHODU;
//    $DATA_POCZATKU_WYPOZYCZENIA = $request->data->DATA_POCZATKU_WYPOZYCZENIA;
//    $DATA_KONCA_WYPOZYCZENIA = $request->data->DATA_KONCA_WYPOZYCZENIA;
